...
file_path =  "/Users/abc/KhoaLuan/apk-files/com.afwsamples.testdpc_9.0.6-9006_minAPI21(nodpi)_apkmirror.com.apk"
rid = RiskInDroid()   
permission = rid.get_permission_json(file_path)
fv = rid.get_feature_vector_from_json(permission)
_test_app = fv["allTypes"]
risk = rid.calculate_risk(fv)
print(risk)