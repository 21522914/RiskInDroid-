...
summary_report = db.Table(
    ...
    db.Column(
        "permission_name", db.String(255), db.ForeignKey("permissions.name")),
    db.Column(
        "declared", db.Integer, db.ForeignKey("permissions.name")),
    db.Column(
        "required_and_used", db.Integer, db.ForeignKey("permissions.name")),
    db.Column(
        "required_but_not_used", db.Integer, db.ForeignKey("permissions.name")),
    db.Column(
        "not_required_but_used", db.Integer, db.ForeignKey("permissions.name")),
